...
module.exports = plugin(function ({ addComponents, theme }) {
  addComponents({
    '.form-control,.datatable-input': {
      '@apply border rounded-lg block text-base py-[.8rem] px-3 w-full placeholder:text-[#bec8d0] disabled:bg-secondary-200/10 disabled:pointer-events-none focus:outline-none focus:border-primary-500 dark:focus:border-primary-500 border-theme-inputborder dark:border-themedark-inputborder bg-theme-inputbg dark:bg-themedark-inputbg':
        {},
      '&[type="file"]': {
        '&::file-selector-button': {
          '@apply py-[.8rem] px-3 -my-[.8rem] -mx-3 me-3 bg-secondary-300/10 cursor-pointer border-0 border-r border-theme-inputborder dark:border-themedark-inputborder shadow-none outline-none':
            {}
        }
      },
      '&.error': {
    ...
    '.form-control-plaintext': {
      '@apply rounded-lg block text-base py-[.8rem] px-3 w-full focus:outline-none placeholder:text-[#bec8d0] disabled:pointer-events-none bg-transparent dark:bg-transparent': {},
    },
    '.form-control-lg': {
      '@apply py-[.775rem] px-[.85rem] text-[1.09375rem] rounded-[10px]': {}
    },
    '.form-control-sm': {
      '@apply py-[.375rem] px-[.7rem] text-[.765625rem] rounded-md': {}
    },
    '.form-select, .datatable-selector': {
      '@apply appearance-none bg-[length:16px_12px] ltr:bg-[right_1rem_center] rtl:bg-[left_1rem_center] bg-no-repeat bg-select-bg dark:bg-select-bg-dark border rounded-lg block text-base py-[.8rem] pl-3 pr-8 w-full focus:outline-none focus:border-primary-500 dark:focus:border-primary-500 border-theme-inputborder dark:border-themedark-inputborder bg-theme-inputbg dark:bg-themedark-inputbg':
        {},
      '&.error': {
        '@apply border-danger-500': {}
      },
    ...
    '.form-select-sm': {
      '@apply py-[.375rem] pl-[.7rem] text-[.765625rem] rounded-[6px]': {}
    },
    '.form-control-color': {
    ...
    '.input-group-text': {
      '@apply flex items-center p-[.8rem_.75rem] text-base border border-theme-inputborder dark:border-themedark-inputborder': {}
    },
    '.input-group': {
      '@apply relative flex flex-wrap items-stretch w-full *:rounded-none ltr:first:*:rounded-l-lg ltr:last:*:rounded-r-lg ltr:*:-ml-px ltr:first:*:ml-0 rtl:*:-mr-px rtl:first:*:mr-0 rtl:first:*:rounded-r-lg rtl:last:*:rounded-l-lg':
        {},
    ...
    '.form-check-input': {
      '@apply w-[1.25em] h-[1.25em] align-text-top appearance-none transition-all bg-contain bg-center bg-no-repeat border border-theme-inputborder dark:border-themedark-inputborder checked:bg-primary-500 checked:border-primary-500 disabled:opacity-50 disabled:pointer-events-none':
        {},
      ...
      '&[type="checkbox"]': {
        '@apply rounded-md checked:bg-checkbox-bg': {}
      },
      '&[type="radio"]': {
    ...
    '.dropzone': {
      '@apply mb-5 min-h-[auto] p-5 cursor-pointer rounded-lg border border-2 border-dashed border-theme-inputborder dark:border-themedark-inputborder bg-theme-inputbg dark:bg-themedark-inputbg':
        {}
    },
